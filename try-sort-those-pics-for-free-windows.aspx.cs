...
public partial class try_win : System.Web.UI.Page
{
    ...
    //3. Allow user to download files.
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        if (Page.IsPostBack)
        {
            ...
            {
                //2. Save user to db tbl.
                db.InsertUserWin(formFname, formSname, formEmail);
    ...
    protected void DownloadFile()
    {
        ...
        string dirToConfirmMain = "~/FileDownloads/Website/Win/";
        string dirToConfirmPathMain = Server.MapPath(dirToConfirmMain);

        string dirToConfirmSub = "~/FileDownloads/Website/Win/stp";
        ...
        catch (HttpException ex)
        {
            ...
            ExceptionUtility.LogException(ex, "Method: DownloadFile; Class: try_win");
        }
